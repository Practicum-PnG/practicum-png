...
data_arg.add_argument('--train_path', type=str, default='./Dataset/train', help="train dataset directory")
data_arg.add_argument('--enroll_path', type=str, default='./Dataset/test/enroll', help="enroll dataset directory")
data_arg.add_argument('--verification_path', type=str, default='./Dataset/test/verification', help="verification dataset directory")
...
train_arg.add_argument('--noise_filenum', type=int, default=1, help="how many noise files will you use")
...
train_arg.add_argument('--iteration', type=int, default=10000, help="max iteration")
